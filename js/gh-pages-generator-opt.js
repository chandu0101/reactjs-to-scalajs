...
ScalaJS.c.LApp$.prototype.setupUI__Lorg_scalajs_jquery_JQuery = (function() {
  return ((0, ScalaJS.g["jQuery"])("#useme")["text"]("Scala JS Rocks"), (0, ScalaJS.g["jQuery"])("body")["append"]("<footer> Cheers ,Happy Coding! </footer>"))
});
ScalaJS.c.LApp$.prototype.$$js$exported$meth$main__O = (function() {
  return (this.setupUI__Lorg_scalajs_jquery_JQuery(), (void 0))
});
...
//# sourceMappingURL=gh-pages-generator-opt.js.map
